<template>
    <div>
        <Spin fix
              v-if="loading"></Spin>
        <div class="pdf-wrap loadingInProgress">
                            ...
                            <div id="toolbarViewer">
                                <div id="toolbarViewerLeft">
                                    ...
                                    <div class="splitToolbarButton hiddenSmallView">
                                        <button class="toolbarButton pageUp"
                                                title="Previous Page"
                                                id="previous"
                        ...
                        <div class="dialog">
                            ...
                            <div class="buttonRow">
                                <button id="printCancel"
                                        class="overlayButton"><span data-l10n-id="print_progress_close">Cancel</span></button>
                            </div>
                        </div>
                    </div>
  ...
  methods: {
    ...
    handlePrevious() {
      ...
      pdfjsLib.getDocument(this.url).then(function(pdf) {
        that.loading = false;
        that.pdf = pdf;
        pdf.getPage(--that.pageNum).then(function(page) {
          that.loading = false;
          that.page = page;
          var scale = that.zoom;
          var viewport = page.getViewport(scale);
