...
(function(modules) {
  ...
  function _webpackRequire(moduleId) {
  ...
  _webpackRequire.m = modules;

  // expose the module cache
  _webpackRequire.c = installedModules;

  // identity function for calling harmony imports with the correct context
  _webpackRequire.i = function(value) {
    return value;
  };

  // define getter function for harmony exports
  _webpackRequire.d = function(exports, name, getter) {
    if (!_webpackRequire.o(exports, name)) {
  ...
  _webpackRequire.n = function(module) {
    var getter =
    ...
    _webpackRequire.d(getter, 'a', getter);
    return getter;
  };

  // Object.prototype.hasOwnProperty.call
  _webpackRequire.o = function(object, property) {
  ...
  return _webpackRequire((_webpackRequire.s = 33));
})([
  function(module, exports, _webpackRequire) {
    ...
    var _pdfjsLib = _webpackRequire(1);
  ...
  function(module, exports, _webpackRequire) {
    ...
    var _ui_utils = _webpackRequire(0);
  ...
  /***/ function(module, exports, _webpackRequire) {
    ...
    var _pdf_cursor_tools = _webpackRequire(6);

    var _pdf_rendering_queue = _webpackRequire(3);

    var _pdf_sidebar = _webpackRequire(24);

    var _pdf_viewer = _webpackRequire(27);

    var _dom_events = _webpackRequire(2);

    var _overlay_manager = _webpackRequire(15);

    var _password_prompt = _webpackRequire(16);

    var _pdf_attachment_viewer = _webpackRequire(17);

    var _pdf_document_properties = _webpackRequire(18);

    var _pdf_find_bar = _webpackRequire(19);

    var _pdf_find_controller = _webpackRequire(7);

    var _pdf_history = _webpackRequire(20);

    var _pdf_link_service = _webpackRequire(5);

    var _pdf_outline_viewer = _webpackRequire(21);

    var _pdf_presentation_mode = _webpackRequire(23);

    var _pdf_thumbnail_viewer = _webpackRequire(26);

    var _secondary_toolbar = _webpackRequire(29);

    var _toolbar = _webpackRequire(31);

    var _view_history = _webpackRequire(32);
    ...
    var PDFViewerApplication = {
      ...
      _initializeViewerComponents: function _initializeViewerComponents() {
        ...
        return new Promise(function(resolve, reject) {
          ...
          _this2.secondaryToolbar = new _secondary_toolbar.SecondaryToolbar(
    ...
    function webViewerInitialized() {
      ...
      Promise.all(waitForBeforeOpening)
        ...
        .catch(function(reason) {
          PDFViewerApplication.l10n
            .get('loading_error', null, 'An error occurred while opening.')
            .then(function(msg) {
  ...
  /***/ function(module, exports, _webpackRequire) {
    ...
    var _grab_to_pan = _webpackRequire(14);
  ...
  /***/ function(module, exports, _webpackRequire) {
    ...
    var _app = _webpackRequire(4);

    var _preferences = _webpackRequire(28);

    var _download_manager = _webpackRequire(12);

    var _genericl10n = _webpackRequire(13);
 ...
 function(module, exports, _webpackRequire) {
      ...
      _createClass(PasswordPrompt, [
        {
          ...
          value: function open() {
            ...
            this.overlayManager.open(this.overlayName).then(function() {
              ...
              if (
                _this2.reason === _pdfjsLib.PasswordResponses.INCORRECT_PASSWORD
              ) {
    ...
    var PDFPresentationMode = (function() {
      function PDFPresentationMode(_ref) {
        ...
        var container = _ref.container,
          ...
          contextMenuItems =
            _ref$contextMenuItems === undefined ? null : _ref$contextMenuItems;
  ...
  /***/ function(module, exports, _webpackRequire) {
    ...
    var _pdf_thumbnail_view = _webpackRequire(25);
  ...
  /***/ function(module, exports, _webpackRequire) {
    ...
    var _annotation_layer_builder = _webpackRequire(11);

    var _dom_events = _webpackRequire(2);

    var _pdf_page_view = _webpackRequire(22);

    var _pdf_link_service = _webpackRequire(5);

    var _text_layer_builder = _webpackRequire(30);
