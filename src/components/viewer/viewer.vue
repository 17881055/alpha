...
#titlebar {
  ...
  background-image: url(images/texture.png),
    linear-gradient(rgba(69, 69, 69, 0.95), rgba(82, 82, 82, 0.99));
  background-image: url(images/texture.png),
    -webkit-linear-gradient(rgba(69, 69, 69, 0.95), rgba(82, 82, 82, 0.99));
  background-image: url(images/texture.png),
    -moz-linear-gradient(rgba(69, 69, 69, 0.95), rgba(82, 82, 82, 0.99));
  background-image: url(images/texture.png),
    -ms-linear-gradient(rgba(69, 69, 69, 0.95), rgba(82, 82, 82, 0.99));
  background-image: url(images/texture.png),
    -o-linear-gradient(rgba(69, 69, 69, 0.95), rgba(82, 82, 82, 0.99));
}
#titlebar a,
#aboutDialog a,
#titlebar a:visited,
#aboutDialog a:visited {
  color: #ccc;
}
#documentName {
  margin-right: 10px;
...
#toolbarContainer {
  ...
  background-image: url(images/texture.png),
    -moz-linear-gradient(rgba(82, 82, 82, 0.99), rgba(69, 69, 69, 0.95));
  background-image: url(images/texture.png),
    -ms-linear-gradient(rgba(82, 82, 82, 0.99), rgba(69, 69, 69, 0.95));
  background-image: url(images/texture.png),
...
.splitToolbarButtonSeparator {
  padding: 8px 0;
  width: 1px;
  background-color: hsla(0, 0%, 00%, 0.5);
  z-index: 99;
