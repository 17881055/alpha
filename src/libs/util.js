...
// 暂时先用 hyxl-cms-user_sessionid 来做sso 以后再改
// export const TOKEN_KEY = 'token';
export const TOKEN_KEY = 'hyxl-cms-user_sessionid';
...
export const getToken = () => {
  ...
  if (token) {
    ...
    var newToken = getRequest(TOKEN_KEY);
    if (newToken) {
      Cookies.set(TOKEN_KEY, newToken, {
        expires: config.cookieExpires || 1
      });
      window.location.href = funcUrlDel(TOKEN_KEY);
      return newToken;
    }
    return false;
  }
